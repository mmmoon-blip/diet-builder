...
public class SolutionBuilder {
    ...
    private double calculateTDEE(PersonContext person) {
        ...
        if (bmr <= 0) {
            ...
            int age = person.getAge() != null ? person.getAge() : 25;
        ...
        if (exerciseFreq != null) {
            if (exerciseFreq >= 5) activityFactor = 1.6;
            else if (exerciseFreq >= 3) activityFactor = 1.4;
            else if (exerciseFreq >= 1) activityFactor = 1.3;
        }
